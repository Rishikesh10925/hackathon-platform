  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        console.error("No events API found. Falling back to dummy data for UI preview.", err);
        setEvents([
...
with open(r'e:\Vcc\frontend\src\pages\AdminDashboard.jsx', 'w', encoding='utf-8') as f:
    f.write(content)
